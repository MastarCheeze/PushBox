...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PushBox2", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PushBox2", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "61";
		app.meta["company"] = "MastarCheeze";
		app.meta["file"] = "PushBox2";
		app.meta["name"] = "Push Box";
